...
def printUsage():
    ...
    parser.add_argument('-f [N]', dest='accumulate', action='store_const',
                        const=sum, default=max,
                        help='Selecciona [N] características mediante PCA')
...
def crossValidationScore(X_train, y_train):
    ...
    fig = plt.figure()
    fig.suptitle(
        'Comparación entre los distintos algoritmos mediante Cross-Validation')
